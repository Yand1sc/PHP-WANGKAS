<div>
  <section class="row">
   ...
   <div class="card">
     <x-apexcharts.pie-chart
        chartTitle="Status Pembayaran SPP"
        chartID="chart-pie-student-spp-status"
        :series="$charts['pieChart']['studentSPPStatus']['series']"
        :labels="$charts['pieChart']['studentSPPStatus']['labels']"
